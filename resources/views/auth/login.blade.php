                            ...
                            <div class="col-md-8 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    ...
                                    <form method="post" action="{{route('authenticate')}}" class="forms-sample" >
                                        ...
                                        <div>
                                            <button name="role" value="teacher" class="btn btn-primary me-2 mb-2 mb-md-0 text-white">Login As Teacher</button>
                                            <button name="role" value="student" class="btn btn-secondary me-2 mb-2 mb-md-0 text-white">Login As Student</button>
                                            <button name="role" value="admin" class="btn btn-secondary me-2 mb-2 mb-md-0 text-white">Login As Admin</button>
                                        </div>
