        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="wd-30 ht-30 rounded-circle" src="{{asset('user_images/'.\Illuminate\Support\Facades\Auth::user()->image)}}" alt="profile">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{asset('user_images/'.\Illuminate\Support\Facades\Auth::user()->image)}}" alt="">
                        </div>
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            @if(\Illuminate\Support\Facades\Auth::user()->name=='admin')
                <li class="breadcrumb-item"><a href="{{route('adminDashbord')}}">User</a></li>
            @elseif(\Illuminate\Support\Facades\Auth::user()->is_teacher==1&& \Illuminate\Support\Facades\Auth::user()->name!='admin')
                <li class="breadcrumb-item"><a href="{{route('teacherDashbord')}}">Teacher</a></li>
            @else
                <li class="breadcrumb-item"><a href="{{route('studentDashboard')}}">Student</a></li>
            @endif
